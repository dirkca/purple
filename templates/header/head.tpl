...
{/foreach}
    ...
    <link rel="stylesheet" type="text/css" href="{theme_url filename='style/topmenu.css'}?v={$RELEASE}" > 
    <link rel="stylesheet" type="text/css" href="{theme_url filename='style/nav.css'}?v={$RELEASE}" >
    <script type="text/javascript" src="{$WWWROOT}js/css.js?v={$RELEASE}"></script>
    <script type="text/javascript" src="{$WWWROOT}js/spacelab/bsa.js?v={$RELEASE}"></script>
    <script type="text/javascript" src="{$WWWROOT}js/spacelab/bootstrap.min.js?v={$RELEASE}"></script>
    <script type="text/javascript" src="{$WWWROOT}js/spacelab/bootswatch.js?v={$RELEASE}"></script>
